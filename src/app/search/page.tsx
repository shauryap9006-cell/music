      ...
      <div className="mb-6 flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
        <div>
          ...
          <p className="mt-2 text-base text-[var(--text-muted)]">
            Search songs, albums, and artists across preview tracks and the shared library.
          </p>
        </div>
          ...
          {songs.length === 0 ? (
            <div className="flex min-h-[24rem] flex-col items-center justify-center gap-4 text-center">
              ...
              <p className="max-w-md text-base leading-7 text-[var(--text-muted)]">
                Search activates as soon as preview songs are found or someone uploads to the shared library.
              </p>
            </div>
          ) : (
                ...
                >
                  {filteredSongs.length > 0 || filteredAlbums.length > 0 || filteredArtists.length > 0 ? (
                    ...
                    <div className="flex min-h-[24rem] flex-col items-center justify-center gap-4 text-center">
                      ...
                      <p className="max-w-md text-base leading-7 text-[var(--text-muted)]">
                        Try another song title, artist, or album after the preview or shared libraries populate.
                      </p>
                    </div>
                  )}
                </motion.div>
...
export default function SearchPage() {
  return (
    <Suspense fallback={<div className="flex min-h-screen items-center justify-center text-white">Loading Search...</div>}>
      <SearchContent />
    </Suspense>
  );
}
